...
var users = {
	phineas: {
		...
		avatar: 'https://cdn.discordapp.com/avatars/352036341153923072/a_189329344806d2ec48692857e1f3bb50.gif?size=1024'
	},
	paragon: {
		username: 'Taxperia',
		nameColor: 'hsl(212, 51%, 59%)',
		bot: true,
		avatar: 'https://cdn.discordapp.com/attachments/768490283770839080/842798834420547614/Taxperia1.png'
	}
};
...
var channelData = [{
	...
	messages: [{
		...
		user: users.paragon,
		embedData: {
			title: 'Taxperia   |   Yardım Listesi',
			pill: 'hsl(202, 35%, 68%)',
			thumb: null,
			fields: [{
				name: '-> Yetkili',
				value: ' !odayaçek, !oto-tag, !reklam-taraması, !tag-taraması, !temizle, !otobotsiliciaç, !cezalı-rol, !mesaj-log,  !isim-değiştir, !süreli-rol'
			}, {
				name: '-> Kullanıcı',
				value: '!ekran-paylaş, !istatistik,  !kullanıcı-bilgi, !sunucu-resmi, langdetect, !website,  !yavaşmod, !sa-as, !kanalbilgi, !avatar, !ping, !desteksunucusu, !sunucubilgi,  !rol-bilgi, !ses, !profil-sistemi  '
			}, {
				name: '-> Koruma',
				value: '!capslock-engelleme, !reklamisimban, !sağ-tık-kick, !anti-raid'
			}, {
				name: '-> Sunucu',
				value: '!ban-sistemi, !otorol-sistemi, !güvenlik-sistemi, !jail-sistemi, !kick-sistemi, !küfür-sistemi, !reklam-sistemi, !susturma-sistemi  '
			}, {
				name: '-> Eğlence',
				value: '!alkış, !atam, !çay, !çeviri, !espiri, !hackle, !rip, !slot, !winner, !olay, !kafadansı, !aykutelmas, !hesaplama,  !kartopu, !token, !patlat,  !spoiler '
			}, {
				name: '-> Daha Fazlası...',
				value: 'Daha fazlası için !bilgi yazabilirsin. Şimdiden iyi eğlenceler kaptan.'
			}]
		}
	}]
}, {
